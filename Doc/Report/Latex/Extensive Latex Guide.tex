...
% ========== Title ===============	
	{	\Huge M2 CORO-ERTS project 2021-2022 :
	 EDF validation \&  \linebreak EDH implementation over Xenomai\\	}
...
\subparagraph{CHECK$\_$SLACK$\_$TIME}\hfill
\newline
...
\vspace{4cm}
 ...
 Xenomai also provides example which are available \href{https://xenomai.org/documentation/xenomai-3/html/xeno3prm/xddp-echo_8c-example.html}{here} as well...
	...
	\begin{itemize}
    	...
    	\caption{Tim handler for battery linux module}
    	\end{figure}
...
\vspace{4cm}
	...
	\begin{itemize}
	    ...
	    \item Section de code à compléter pour calculer les 2 paramètres suivants : \textbf{Slack\_time} et \textbf{Slack\_energy} (corps de fonctions prêt, prêt à coder...)
	    \item Utilisation de Cheddar pour validation EDF
	    \item Utilisation du \textbf{fake battery module} pour simplifier les tests
